...
class WaypointUpdater(object):
    ...
    def get_closest_waypoint_idx(self):
    	...
    	closest_idx = self.waypoint_tree.query([x, y], 1)[1] # index of the closest point in KB tree
    	...
    	if val > 0: # behind the car, take the next one
    ...
    def waypoints_cb(self, waypoints):
        # TODO: Implement
        self.base_waypoints = waypoints # latched subscriber, only calls once
